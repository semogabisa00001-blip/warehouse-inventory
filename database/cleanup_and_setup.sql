...
DROP POLICY IF EXISTS "Administrators can update categories" ON categories;
DROP POLICY IF EXISTS "Administrators can delete categories" ON categories;
DROP POLICY IF EXISTS "Anyone can view parts" ON parts;
DROP POLICY IF EXISTS "Authenticated users can insert parts" ON parts;
DROP POLICY IF EXISTS "Administrators can update parts" ON parts;
DROP POLICY IF EXISTS "Administrators can delete parts" ON parts;
DROP POLICY IF EXISTS "Anyone can view inbound headers" ON inbound_headers;
DROP POLICY IF EXISTS "Authenticated users can insert inbound headers" ON inbound_headers;
DROP POLICY IF EXISTS "Administrators can update inbound headers" ON inbound_headers;
DROP POLICY IF EXISTS "Administrators can delete inbound headers" ON inbound_headers;
DROP POLICY IF EXISTS "Anyone can view inbound details" ON inbound_details;
DROP POLICY IF EXISTS "Authenticated users can insert inbound details" ON inbound_details;
DROP POLICY IF EXISTS "Administrators can update inbound details" ON inbound_details;
DROP POLICY IF EXISTS "Administrators can delete inbound details" ON inbound_details;
DROP POLICY IF EXISTS "Anyone can view outbound headers" ON outbound_headers;
DROP POLICY IF EXISTS "Authenticated users can insert outbound headers" ON outbound_headers;
DROP POLICY IF EXISTS "Administrators can update outbound headers" ON outbound_headers;
DROP POLICY IF EXISTS "Administrators can delete outbound headers" ON outbound_headers;
DROP POLICY IF EXISTS "Anyone can view outbound details" ON outbound_details;
DROP POLICY IF EXISTS "Authenticated users can insert outbound details" ON outbound_details;
DROP POLICY IF EXISTS "Administrators can update outbound details" ON outbound_details;
DROP POLICY IF EXISTS "Administrators can delete outbound details" ON outbound_details;
...
CREATE INDEX idx_inbound_details_header ON inbound_details(inbound_header_id);
CREATE INDEX idx_inbound_details_part ON inbound_details(part_id);
CREATE INDEX idx_outbound_details_header ON outbound_details(outbound_header_id);
CREATE INDEX idx_outbound_details_part ON outbound_details(part_id);
